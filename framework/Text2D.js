...
//IMPORTANT, l'objet Text2D DOIT appartenir a une view
...
Text2D.prototype.getWidth = function(ctx)
{
...
Text2D.prototype.getHeight = function(ctx)
{
 var metrics = ctx.measureText(this.text);
 return 0;
}
...
Text2D.prototype.draw = function(context, view, x_local, y_local)
{
 context.save();
