...
//le constructeur de la view prend en parametre un objet window parent, un x, un y,
...
//Permet de set la rotation de la view
View.prototype.setRotation = function(rot)
{
 this.rotation = rot;
}

//Permet de recuperer la rotation de la vue
...
var i = 0;
 ...
 this.context.transform(Math.cos(this.rotation), -Math.sin(this.rotation), Math.sin(this.rotation), Math.cos(this.rotation), 0, 0);
 this.context.transform(this.x_scale, 0, 0, this.y_scale, 0, 0);
 this.context.transform(1, 0, 0, 1, -this.x_center, -this.y_center);
 while (i < length)
  {
  if (this.listView[i].getX() < this.width && this.listView[i].getX() + this.listView[i].getWidth(this.context) >= 0 &&
      this.listView[i].getY() < this.height && this.listView[i].getY() + this.listView[i].getHeight(this.context) >= 0)
 ...
 while (i < length)
  ...
  if (this.listSprite[i].getX() < this.width && this.listSprite[i].getX() + this.listSprite[i].getWidth() >= 0 &&
     ...
     this.listSprite[i].draw(this.context, this);
   i++;
  }
